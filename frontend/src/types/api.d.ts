...
export interface paths {
    ...
    "/deposit/sui-verify": {
        ...
        get?: never;
        put?: never;
        /** Verify Sui deposit and credit USDC */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["DepositSuiVerifyRequest"];
                };
            };
            responses: {
                /** @description Deposit verified and account credited */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": components["schemas"]["DepositSuiVerifyResponse"];
                    };
                };
                /** @description Unauthorized — missing or invalid JWT */
                401: {
...
export interface components {
    schemas: {
        ...
        DepositSuiVerifyRequest: {
            /** @example "0xabc123..." */
            txDigest: string;
            /** @example "deposit_123_1745..." */
            nonce: string;
            /** @example "1000000" */
            amount: string;
            /** @example "0xa1ec7fc00a6f40db..." */
            coinType: string;
        };
        DepositSuiVerifyResponse: {
            /** @example true */
            success: boolean;
            /** @example "0xabc123..." */
            txDigest?: string;
            ...
            /** @example "1.0" */
            usdmxAmount?: string;
            /** @example "PaymentReceipt not found" */
            error?: string;
        };
        ChatSession: {
            /**
